...
public class ExecuteUpdate01 {
    public static void main(String[] args) throws SQLException {
        ...
        //  ÖRNEK1:developers tablosunda maaşı ortalama
        //  maaştan az olanların maaşını ortalama maaş ile güncelleyiniz
        ...
        System.out.println("Guncellenen kayit sayisi:"+update);
